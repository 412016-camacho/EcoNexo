...
public class EmailServiceImpl implements  EmailService {
    ...
    @Async
    @Override
    public void sendCertificateEmail(String toEmail, String subject, String body, byte[] pdfBytes, String fileName) {
        try {
            MimeMessage message = mailSender.createMimeMessage();
            MimeMessageHelper helper = new MimeMessageHelper(message, true, "UTF-8");
            ...
            logger.error("Fail attempt to send certificate to email to " + toEmail + ": " + e.getMessage());
        }
    }
